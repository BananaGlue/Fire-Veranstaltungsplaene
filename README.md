...
| Punkt [1-50] | Darstellung von durchnummerierten Punkten. Der Kontext ergibt sich aus weiteren Kartenelementen der Umgebung oder aus dem optionalen Titel. | Zufahrtspunkt 1 |
| Punkt [A-Z] | Darstellung von durchbustabierten Punkten. Der Kontext ergibt sich aus weiteren Kartenelementen der Umgebung oder aus dem optionalen Titel. | Hauptbühne |
...
| Punkt [1-50] | #00FF00AA | `[1-50].circle.fill` |
| Punkt [A-Z] | #8F34EBAA | `[A-Z].circle.fill` |
